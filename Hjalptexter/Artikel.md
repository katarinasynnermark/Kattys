...
| [Systemteknisk anmärkning](#systemteknisk-anmarkning)| [Utgivningssätt](#utgivningssatt) | [Verkets titel](#verkets-titel) |
...
I Libris rekommenderas att man för bidrag alltid länkar till eller beskriver årsbokens/tidskriftens huvudpost, även när en årsboksårgång eller ett tidskriftshäfte har en monografisk/tematisk karaktär (med egen, distinkt titel, fullständig titelsida o.s.v., eller har en tematitel). 
