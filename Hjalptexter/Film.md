...
##### Varianttitel
En varianttitel är en titel som hör samman med resursen och som skiljer sig från den titel som angetts som huvudtitel. Ange varianttitlar som bedöms vara viktiga för identifikation och åtkomst. Varianttitlar kan hämtas från vilken källa som helst.
