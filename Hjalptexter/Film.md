...
För att lägga till Har titel, klicka på plustecknet Lägg till egenskaper under: Instans.  
  Återge huvudtiteln så som den förekommer i källan, se [Librispraxis 2.2.2.3](http://access.rdatoolkit.org/kbspchp2_kbsp2-38.html). Om titeln förekommer i källan på mer än ett språk eller i mer än en skriftart, se [Librispraxis 2.3.2.4](http://access.rdatoolkit.org/kbspchp2_kbsp2-84.html).  
 ```Exempel: Rescuers```  
