...
* Språk (language = 008/35-37)</BR>
  Ange det talade eller sjungna språket här. Om filmen innehåller flera dubbningar samt originalversionen ange originalversionens språk. </BR>Länka till entitet.  
